		...
		// TODO Auto-generated method stub
				...
				try {
					...
					while (rs.next()) {
						...
						Cart cart = new Cart(magiohang, sach, kh, tensach, tacgia, gia, tongtien);
...
//		return ketQua;
	...
	public int delete(Cart t) {
		...
		try {
			...
			PreparedStatement st = con.prepareStatement(sql);
			st.setInt(1, t.getKhachHang().getMaKhachHang());
			st.setInt(2, t.getSach().getMaSach());
			...
			// Bước 4:
			System.out.println("cau lenh sql: " + sql);
			System.out.println("xoa sach khoi gio hang thanh cong: ");
