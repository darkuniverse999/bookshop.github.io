            ...
            <div class="col-md-6 ">
                <div class="card">
                    <div class="card-body">
                        ...
                        %>
                            	<tr>
                                    <td><a  href="DeleteCartServlet?cartid=<%=cart.getMaGioHang() %>" ><i class="fa-solid fa-minus"></i></a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mydiv text-center mt-3 mb-5 ">
                            <div title="Đặt hàng ngay" class="btn btn-warning mx-3 text-white">Đặt hàng ngay</div>
