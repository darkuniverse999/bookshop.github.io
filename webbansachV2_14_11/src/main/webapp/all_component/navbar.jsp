					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<li class="nav-item"><a href="index.jsp" class="nav-link active"
							aria-current="page" href="#"><i class="fa-solid fa-house"></i>Trang
								chủ</a></li>
						<li class="nav-item"><a href="newbook.jsp" class="nav-link" href="#">Sách
								mới</a></li>
		...
		<div class="col-md-3">
			<form action="" method="post" class="d-flex " role="search">
				<input class="form-control me-2" type="search"
					placeholder="Nhập tên sách, tác giả...." name="searchbook">
		...
		<div class="col-md-3 d-flex justify-content-end align-items-center">
			...
			<c:if test="${not empty khachHang}">
				...
				<ul class="dropdown-menu">
					...
					<li><a class="dropdown-item" href="#">Quyên góp sách cũ</a></li>
					<li><hr class="dropdown-divider"></li>
