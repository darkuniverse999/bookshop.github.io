...
public class Sach {
	...
	*/
	...
	public String toString() {
		return "Sach [maSach=" + maSach + ", tenSach=" + tenSach + ", tacGia=" + tacGia + ", giaGoc=" + giaGoc
				+ ", giaBan=" + giaBan + ", loaiSach=" + loaiSach + ", namXuatBan=" + namXuatBan + ", trangThai="
				+ trangThai + ", theLoai=" + theLoai + ", photo=" + photo + ", email=" + email + ", soLuong=" + soLuong
				+ "]";
	}
