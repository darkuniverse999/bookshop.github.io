...
<body style="background-color: #f0f1f2; ">
    ...
    <div class="container mt-5 " style="border-radius: 6px;">
                            ...
                            <form action="">
                                <div class="d-flex flex-wrap justify-content-between ">
                                    ...
                                    <div class="col-md-4 mb-3 mt-2 d-flex text-nowrap align-items-center">
                                        <label for="exampleFormControlInput1" class="form-label align-items-center">Số lượng:</label>

                                        <input type="number" class="form-control khungSoLuong" id="exampleFormControlInput1 "
                                            value="1">
                                    </div> <!-- end div col trong form -->
