		...
		<div class="row">
			...
			<table class="table table-striped">
				...
				%>
					...
					<tbody>
					<tr>
						<th scope="row"><%=sach.getMaSach()%></th>
						<td><img alt="" src="../book/<%=sach.getPhoto()%>" style="width: 50px; height: 50px"></td>
						<td><%=sach.getTenSach()%></td>
						<td><%=sach.getTacGia()%></td>
						<td><%=sach.getGiaBan()%></td>
						<td><%=sach.getLoaiSach()%></td>
						<td><%=sach.getNXB()%></td>
						<td><%=sach.getTrangThai()%></td>
						...
						<td>
							...
							<a href="admin_allbook.jsp?id=<%=sach.getMaSach()%>" data-bs-toggle="modal" data-bs-target="#exampleModal2"><div class="btn btn-danger"><i class="fa-regular fa-square-minus iconCachPhai"></i>Xóa</div></a>
						        ...
						        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
						            <div class="modal-content">
						                <div class="modal-header">
						                    <h1 class="modal-title fs-5 text-danger" id="exampleModalLabel"><i class="fa-solid fa-triangle-exclamation iconCachPhai"></i>Thông báo!</h1>
						                ...
						                <div class="modal-footer">
						                	<a href="../DeleteBookServlet?id=<%=sach.getMaSach()%>" ><button type="button" class="btn btn-primary">Đồng ý</button></a>
