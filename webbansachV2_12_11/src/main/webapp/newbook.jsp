...
<body>
	...
	<div class="container mt-5">
		<div class="row text-center">
			<h3 class="mb-3 myfontfamily">KHO SÁCH MỚI</h3>
		</div>
		<div class="row">
				...
				<div class="col-md-3 mb-5">
					<div class="card h-100" style="width: 12em;">
						...
						<div class="card-footer mycardfooter text-center">
							<a title="Đặt hàng ngay" href="#" class="btn btn-danger">Mua</a>
							<a title="Thêm vào giỏ hàng" href="#" class="btn btn-danger"><i
		...
		<!-- end row show new book -->

		
	</div>
	<!-- end container new book -->
